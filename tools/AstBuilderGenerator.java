...
Adjust mappings as your AST class constructors evolve. */ public class AstBuilderGenerator { private static final String OUTPUT_PATH = "src/danex/AstBuilder.java";

public static void main(String[] args) throws IOException { System.out.println("Working dir: " + System.getProperty("user.dir")); System.out.println("Starting AstBuilder generation..."); StringBuilder sb = new StringBuilder(); sb.append("package danex;\n\n"); sb.append("import danex.antlr.DanexParser;\n"); sb.append("import danex.antlr.DanexParserBaseVisitor;\n"); sb.append("import danex.ast.*;\n"); sb.append("import org.antlr.v4.runtime.tree.TerminalNode;\n"); sb.append("import java.util.*;\n\n"); sb.append("public class AstBuilder extends DanexParserBaseVisitor<Object> {\n\n");
